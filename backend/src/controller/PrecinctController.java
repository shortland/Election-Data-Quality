...
//TODO: find out how to comunicate with serverManager
public class PrecinctController {
    public PrecicntController(){

    }

    public ControllerError deletePrecinct(int precinctId) {

    }

    // + getShapeOfPrecinct(int precinctID) : Polygon
    // + updateShapeOfPrecinct(int precinctID, Polygon shape) : Error
    // + createNewPrecinct(Polygon shape) : Error
    // + deletePrecinct(int precinctID) : Error
    ...
    // + getMultiplePrecinctShapes(Array<int> precinctList) : Array<Polygon>
    // + getMultipleOriginalPrecinctShapes(Array<int> precinctList) : Array<Polygon>
    // + defineGhostPrecinct(int precinctID) : Error
    // + getNeighborsOfPrecinct(int precinctID) : Array<int> precinctIDs
