...
public class State {
    ...
    public State(int id, String stateName, String stateAbreviation, HashSet<Integer> counties, HashSet<Integer> districts){
    ...
    public HashSet<Integer> getDistirctsId(){
    ...
    //TODO
    //DAVID_NOTE: Idk how to compute this because we need the managers to get all precint's VotingData
    public VotingData computeVotingData(){
        return null;
    }

    //TODO
    //DAVID_NOTE: Idk how to compute this because we need the managers to get all precint's DemographicData
