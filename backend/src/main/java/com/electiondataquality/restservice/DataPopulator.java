...
// import
// com.electiondataquality.features.congressional_district.CongressionalDistrict;
...
// public DataPopulator(ServerManager serverManager, DatabaseConfig
// databaseConfig) {
...
// // EntityManagerFactory emFactory =
// // Persistence.createEntityManagerFactory("StateTable");
...
// Persistence.createEntityManagerFactory("CongressionalTable");
...
// CongressionalDistrict(cdFeature);
...
// // PrecinctError er = new PrecinctError(ERROR_TYPE.NO_VOTERS, 1, "has no
// voter",
// // false, comments);
// // PrecinctError er1 = new PrecinctError(ERROR_TYPE.GHOST, 2, "is ghost",
// false,
// // comments);
...
// // Precinct p = new Precinct(10409, "P1", "Precinct1", 10, vd, dd,
// neighborId,
// // errors, null);
...
// // Precinct p1 = new Precinct(10222, "P1", "p1Precicnt", 10, vd, dd,
// neighbor,
// // errors);
// // HashSet<Precinct> precinctSet = new HashSet<Precinct>();
// // precinctSet.add(p);
...
// // precincts);
// // HashSet<CongressionalDistrict> cdSet = new
// HashSet<CongressionalDistrict>();
// // cdSet.add(cd);
// // cdSet.add(cd1);
